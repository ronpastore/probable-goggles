...
function App() {
  return (
    <div className="App">    
      <iframe sandbox="allow-scripts allow-same-origin allow-popups" width="300" height="300" src="https://read.amazon.com/kp/card?asin=B07H6Z1GR8&preview=inline&linkCode=kpe&ref_=cm_sw_r_kb_dp_F5RGHQ7YX2JATHB1PYQX" ></iframe>
